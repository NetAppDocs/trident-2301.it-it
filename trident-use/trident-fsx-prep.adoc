...
| `smbShare` | Nome della condivisione SMB creata utilizzando la cartella condivisa Microsoft Management Console. Ad esempio "smb-share". *Obbligatorio per volumi SMB.* | `smb-share` 
