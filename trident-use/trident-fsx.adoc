...
Amazon FSX per NetApp ONTAP utilizza https://docs.netapp.com/us-en/ontap/fabricpool/index.html["FabricPool"^] per gestire i Tier di storage. Consente di memorizzare i dati in un Tier, in base all'accesso frequente ai dati.
