...
----
. Utilizzare `helm install` e specificare un nome per la distribuzione come nell'esempio seguente dove `23.01.1` È la versione di Astra Trident che si sta installando.
+
[listing]
----
